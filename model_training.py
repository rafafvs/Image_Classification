...
class CNN(nn.Module):
    ...
    def __init__(self, dropout_prob,n_classes):
        """
    ...
    def forward(self, x):
        ...
        #     x.shape = [8, 1, 28, 28]
        # Convolution with 5x5 filter padding and 8 channels =>
        #     x.shape = [8, 8, 28, 28] since 28 = 28 - 5 + 1 + 2*2
        ...
        #     x.shape = [8, 16, 12, 12] since 8 = 16 - 3 + 1
        # Max pooling with stride of 2 =>
...
def main():
    ...
    model = CNN(opt.dropout,n_classes)
